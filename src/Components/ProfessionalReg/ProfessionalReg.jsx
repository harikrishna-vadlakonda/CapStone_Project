     ...
     <form className="mx-auto px-auto">
       ...
       >
                   <select className=" form-control">
                       ...
                       <option className="font-weight-bold text-primary" disabled>ELECTRICAL SERVICES</option>
                 ...
                 <option >Electricity Breakdown</option>
                       ...
                       <option className="font-weight-bold text-primary" disabled>CARPENTER SERVICES</option>

                       <option>Repairs & Fixes</option>
                       <option>New Furniture Making</option>
                       <option>Other Wood Work</option>
                       <option>Door & Window Repairs</option>
                       <option className="font-weight-bold text-primary" disabled>BEAUTY SERVICES</option>
                       ...
                       <option className="font-weight-bold text-primary" disabled>TUTORIAL SERVICES</option>

                       <option>IT Courses</option>
                       <option>Exam Preparation</option>
                       <option>Home Tuitions</option>
                       <option>Music Classes</option>
                       <option className="font-weight-bold text-primary" disabled>CLEANING&WASHING SERVICES</option>
